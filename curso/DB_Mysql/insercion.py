...
try:
    ...
    if conexion.is_connected():
        ...
        sentencia = "INSERT INTO usuarios(primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, num_telefono, email) VALUES('{0}', '{1}', '{2}', '{3}', '{4}', '{5}')".format(nom1, nom2, ape1, ape2, tel, correo)
